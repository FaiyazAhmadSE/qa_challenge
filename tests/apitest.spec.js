...
test.describe('PokeAPI Tests', () => {
    ...
    test('Validate /berry/{id or name} with valid and invalid inputs', async () => {
        const validId = 1;
    ...
    test('Validate /berry-flavor/{name} and process spicy berries', async () => {
        ...
        // Call /berry/{name} using the most potent berry's name
